...
DEFAULT_SETTINGS = {
    ...
    # Chi USA l'app, che non e' la stessa cosa dell'attivita': «Studio Bianchi
    # Fisioterapia» va sulla fattura, «Anna» serve per salutarla. Il nome non
    # si ricava dall'altro: da quella ragione sociale verrebbe «Ciao Studio».
    'owner_first_name': '',
    'owner_last_name': '',
    'business_name': '',
    'business_uid': '',
