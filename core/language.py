...
TESTI = {
    'en': {
        ...
        'Il file del logo da caricare': 'The logo file to upload',
        'I tuoi dati': 'Your details',
        'Sono le righe stampate in cima a ogni fattura. Si scrivono una volta sola: da qui in avanti l’app le mette da sé. Il resto — posta, banca, calendario — si aggiunge quando serve, in Impostazioni.': 'These are the lines printed at the top of every invoice. You write them once: from here on the app fills them in itself. The rest — mail, bank, calendar — you add when you need it, in Settings.',
        'Il nome con cui fatturi. Va sulla prima riga e sul bollettino QR.': 'The name you invoice under. It goes on the first line and on the QR slip.',
        'Il numero d’impresa svizzero, se ce l’hai. Se non ce l’hai, lascia vuoto: la riga sparisce.': 'The Swiss business number, if you have one. If you do not, leave it empty: the line disappears.',
        'Via e numero da una parte, CAP e città dall’altra: il bollettino QR li vuole separati e non li sa indovinare.': 'Street and number on one line, postcode and town on the other: the QR slip wants them apart and cannot guess.',
        'Il conto su cui vuoi essere pagato. È la cosa che si dimentica più facilmente e che costa di più.': 'The account you want to be paid into. It is the thing most easily forgotten, and the most expensive to forget.',
        'Non vanno sulla fattura: servono solo perché l’app sappia come chiamarti.': 'These do not go on the invoice: they are only so the app knows what to call you.',
        'Salva e vai avanti': 'Save and carry on',
        'In cima alla fattura': 'At the top of the invoice',
        'logo': 'logo',
        'Mario Rossi Personal Training': 'John Smith Personal Training',
        'Salvato.': 'Saved.',
        'Salvato: adesso l’app ha tutto quello che le serve per fare una fattura.': 'Saved: the app now has everything it needs to make an invoice.',
        ...
        'In ritardo': 'Overdue',
        'da spedire': 'to send',
        'non va spedita': 'not to be sent',
        'Non ancora spedita.': 'Not sent yet.',
        'Questa non va spedita': 'This one is not to be sent',
        'Rimettila fra quelle da spedire': 'Put it back among those to send',
        'Segnata come da non spedire il {data}.': 'Marked as not to be sent on {data}.',
        'Torna fra quelle da spedire.': 'Back among those to send.',
        'Non te la ricordo più: la #{n} resta qui, ma non è più fra le cose da fare. Puoi ripensarci quando vuoi.': 'I will not remind you again: #{n} stays here, but it is no longer among the things to do. You can change your mind whenever you like.',
        ...
        'Vai ai servizi': 'Go to services',
        '{usate} di {disponibili} usate': '{usate} of {disponibili} used',
        '{nuove} del mese + {riportate} dal mese prima': '{nuove} this month + {riportate} from last month',
        '{n} in più': '{n} extra',
        'mese senza fattura': 'month without invoice',
        'scade il {data}': 'expires on {data}',
        'scaduto il {data}, {n} non usate': 'expired on {data}, {n} unused',
        'Mese di sedute {id}': 'Session month {id}',
        'in più': 'extra',
        'Sedute in più': 'Extra sessions',
        'seduta': 'session',
        'sedute': 'sessions',
        '{chi} — oltre quelle del mese': '{chi} — beyond the month’s sessions',
        ...
        'Testo della riga': 'Line text',
        'Righe': 'Lines',
        'Servizio di «{testo}»': 'Service of «{testo}»',
        'Scegli…': 'Choose…',
        'non lo vendi più': 'no longer sold',
        'Nessun servizio': 'No service',
        'Nuovo servizio con questo nome…': 'New service with this name…',
        'Tutte le righe hanno il loro servizio. Qui non resta niente da fare.':
            'All lines have their service. Nothing left to do here.',
        'Fatto': 'Done',
        'Un testo di righe vecchie non ha ancora un servizio.': 'One text of old lines has no service yet.',
        '{n} testi di righe vecchie non hanno ancora un servizio.': '{n} texts of old lines have no service yet.',
        'Sistemali': 'Sort them out',
        'Righe sistemate: {n}.': 'Lines sorted: {n}.',
        '«{nome}» salvato e collegato alle sue righe.': '«{nome}» saved and linked to its lines.',
        ...
        'Ancora nessun servizio. Scrivi il primo qui sotto: diventa un pulsante della nuova fattura.':
            'No services yet. Write the first one below: it becomes a button on the new invoice.',
        '+ Nuovo servizio': '+ New service',
        'Non lo vendo più': 'I no longer sell it',
        'Non li vendi più': 'No longer sold',
        'Lo vendo di nuovo': 'I sell it again',
        'Come si chiama?': 'What is it called?',
        'Quanto costa?': 'How much does it cost?',
        'Si paga': 'Paid',
        'Una volta': 'Once',
        'Ogni mese': 'Every month',
        'Comprende sedute?': 'Includes sessions?',
        'No': 'No',
        'Sì': 'Yes',
        'Quante sedute': 'How many sessions',
        'al mese': 'a month',
        'Le sedute scadono?': 'Do the sessions expire?',
        'Mai': 'Never',
        'Dopo': 'After',
        'Quanti mesi': 'How many months',
        'mesi': 'months',
        'Le sedute non usate': 'Unused sessions',
        'Si perdono': 'Are lost',
        'Passano al mese dopo': 'Carry over to the next month',
        'Al massimo': 'At most',
        'Quante al massimo in un mese': 'How many at most in a month',
        'in un mese': 'in a month',
        'Questo servizio è già in qualche fattura: cambiare prezzo o sedute vale per le fatture nuove, non per quelle già fatte.':
            'This service is already on some invoices: changing price or sessions applies to new invoices, not to those already made.',
        '«{nome}» salvato.': '«{nome}» saved.',
        'Non posso rimetterlo in vendita: un altro servizio in vendita ha già lo stesso nome.':
            'I can’t put it back on sale: another service on sale already has the same name.',
        'Di nuovo in vendita: il pulsante torna nella nuova fattura.':
            'On sale again: the button is back on the new invoice.',
        'Tolto dai pulsanti della fattura. Le fatture già fatte non cambiano.':
            'Removed from the invoice buttons. Invoices already made do not change.',
        'Scrivi come si chiama il servizio.': 'Write what the service is called.',
        'C’è già un servizio che si chiama «{nome}».': 'There is already a service called «{nome}».',
        'Scrivi quanto costa il servizio.': 'Write how much the service costs.',
        'Il prezzo «{prezzo}» non si capisce: scrivilo per esempio 110.-':
            'The price «{prezzo}» is not clear: write it like 110.-',
        'Le sedute vanno da 1 a 99.': 'Sessions go from 1 to 99.',
        'I mesi di scadenza vanno da 1 a 60.': 'Expiry months go from 1 to 60.',
        'Il massimo non può essere minore delle sedute del mese ({sedute}).':
            'The maximum cannot be lower than the monthly sessions ({sedute}).',
        '1 seduta': '1 session',
        '{n} sedute': '{n} sessions',
        '1 mese': '1 month',
        '{n} mesi': '{n} months',
        'manca il prezzo': 'price missing',
        'Manca il prezzo.': 'Price missing.',
        '{prezzo} al mese': '{prezzo} a month',
        '{prezzo} al mese.': '{prezzo} a month.',
        '{prezzo}, una volta.': '{prezzo}, one-off.',
        '{sedute} al mese': '{sedute} a month',
        '{sedute}, da usare entro {mesi}.': '{sedute}, to be used within {mesi}.',
        '{sedute}, senza scadenza.': '{sedute}, no expiry.',
        'Ogni mese {sedute}; quelle non usate passano al mese dopo, ma in un mese non se ne possono avere più di {massimo}.':
            'Every month {sedute}; unused ones carry over to the next month, but no more than {massimo} can be held in a month.',
        'Ogni mese {sedute}; quelle non usate si perdono.': 'Every month {sedute}; unused ones are lost.',
    ...
    'de': {
        ...
        'Il file del logo da caricare': 'Die hochzuladende Logo-Datei',
        'I tuoi dati': 'Deine Angaben',
        'Sono le righe stampate in cima a ogni fattura. Si scrivono una volta sola: da qui in avanti l’app le mette da sé. Il resto — posta, banca, calendario — si aggiunge quando serve, in Impostazioni.': 'Das sind die Zeilen, die oben auf jeder Rechnung stehen. Du schreibst sie einmal: ab dann setzt die App sie selbst ein. Den Rest — Post, Bank, Kalender — fügst du hinzu, wenn du ihn brauchst, in den Einstellungen.',
        'Il nome con cui fatturi. Va sulla prima riga e sul bollettino QR.': 'Der Name, unter dem du Rechnungen stellst. Er steht auf der ersten Zeile und auf dem QR-Beleg.',
        'Il numero d’impresa svizzero, se ce l’hai. Se non ce l’hai, lascia vuoto: la riga sparisce.': 'Die Schweizer Unternehmens-Identifikationsnummer, falls du eine hast. Wenn nicht, lass das Feld leer: die Zeile fällt weg.',
        'Via e numero da una parte, CAP e città dall’altra: il bollettino QR li vuole separati e non li sa indovinare.': 'Strasse und Nummer auf die eine Zeile, PLZ und Ort auf die andere: der QR-Beleg will sie getrennt und kann sie nicht erraten.',
        'Il conto su cui vuoi essere pagato. È la cosa che si dimentica più facilmente e che costa di più.': 'Das Konto, auf das du bezahlt werden willst. Es wird am leichtesten vergessen und kostet am meisten.',
        'Non vanno sulla fattura: servono solo perché l’app sappia come chiamarti.': 'Sie stehen nicht auf der Rechnung: sie sind nur da, damit die App weiss, wie sie dich nennen soll.',
        'Salva e vai avanti': 'Speichern und weiter',
        'In cima alla fattura': 'Oben auf der Rechnung',
        'logo': 'Logo',
        'Mario Rossi Personal Training': 'Hans Muster Personal Training',
        'Salvato.': 'Gespeichert.',
        'Salvato: adesso l’app ha tutto quello che le serve per fare una fattura.': 'Gespeichert: Die App hat jetzt alles, was sie für eine Rechnung braucht.',
        ...
        'da spedire': 'zu senden',
        'non va spedita': 'wird nicht versendet',
        'Non ancora spedita.': 'Noch nicht versendet.',
        'Questa non va spedita': 'Diese wird nicht versendet',
        'Rimettila fra quelle da spedire': 'Zurück zu den zu versendenden',
        'Segnata come da non spedire il {data}.': 'Am {data} als nicht zu versenden markiert.',
        'Torna fra quelle da spedire.': 'Wieder bei den zu versendenden.',
        'Non te la ricordo più: la #{n} resta qui, ma non è più fra le cose da fare. Puoi ripensarci quando vuoi.': 'Ich erinnere dich nicht mehr daran: Nr. {n} bleibt hier, gehört aber nicht mehr zu den Aufgaben. Du kannst es dir jederzeit anders überlegen.',
        ...
        'Vai ai servizi': 'Zu den Leistungen',
        '{usate} di {disponibili} usate': '{usate} von {disponibili} genutzt',
        '{nuove} del mese + {riportate} dal mese prima': '{nuove} diesen Monat + {riportate} vom Vormonat',
        '{n} in più': '{n} zusätzlich',
        'mese senza fattura': 'Monat ohne Rechnung',
        'scade il {data}': 'läuft ab am {data}',
        'scaduto il {data}, {n} non usate': 'abgelaufen am {data}, {n} nicht genutzt',
        'Mese di sedute {id}': 'Sitzungsmonat {id}',
        'in più': 'zusätzlich',
        'Sedute in più': 'Zusätzliche Sitzungen',
        'seduta': 'Sitzung',
        'sedute': 'Sitzungen',
        '{chi} — oltre quelle del mese': '{chi} — über die Sitzungen des Monats hinaus',
        ...
        'Testo della riga': 'Zeilentext',
        'Righe': 'Zeilen',
        'Servizio di «{testo}»': 'Leistung für «{testo}»',
        'Scegli…': 'Auswählen…',
        'non lo vendi più': 'nicht mehr im Angebot',
        'Nessun servizio': 'Keine Leistung',
        'Nuovo servizio con questo nome…': 'Neue Leistung mit diesem Namen…',
        'Tutte le righe hanno il loro servizio. Qui non resta niente da fare.':
            'Alle Zeilen haben ihre Leistung. Hier gibt es nichts mehr zu tun.',
        'Fatto': 'Fertig',
        'Un testo di righe vecchie non ha ancora un servizio.': 'Ein Text alter Zeilen hat noch keine Leistung.',
        '{n} testi di righe vecchie non hanno ancora un servizio.': '{n} Texte alter Zeilen haben noch keine Leistung.',
        'Sistemali': 'Ordne sie zu',
        'Righe sistemate: {n}.': 'Zeilen zugeordnet: {n}.',
        '«{nome}» salvato e collegato alle sue righe.': '«{nome}» gespeichert und seinen Zeilen zugeordnet.',
        ...
        'Ancora nessun servizio. Scrivi il primo qui sotto: diventa un pulsante della nuova fattura.':
            'Noch keine Leistungen. Schreib die erste hier unten: Sie wird ein Knopf auf der neuen Rechnung.',
        '+ Nuovo servizio': '+ Neue Leistung',
        'Non lo vendo più': 'Verkaufe ich nicht mehr',
        'Non li vendi più': 'Nicht mehr im Angebot',
        'Lo vendo di nuovo': 'Verkaufe ich wieder',
        'Come si chiama?': 'Wie heisst sie?',
        'Quanto costa?': 'Was kostet sie?',
        'Si paga': 'Bezahlt wird',
        'Una volta': 'Einmal',
        'Ogni mese': 'Jeden Monat',
        'Comprende sedute?': 'Mit Sitzungen?',
        'No': 'Nein',
        'Sì': 'Ja',
        'Quante sedute': 'Wie viele Sitzungen',
        'al mese': 'pro Monat',
        'Le sedute scadono?': 'Verfallen die Sitzungen?',
        'Mai': 'Nie',
        'Dopo': 'Nach',
        'Quanti mesi': 'Wie viele Monate',
        'mesi': 'Monaten',
        'Le sedute non usate': 'Nicht genutzte Sitzungen',
        'Si perdono': 'verfallen',
        'Passano al mese dopo': 'gehen in den nächsten Monat über',
        'Al massimo': 'Höchstens',
        'Quante al massimo in un mese': 'Wie viele höchstens in einem Monat',
        'in un mese': 'in einem Monat',
        'Questo servizio è già in qualche fattura: cambiare prezzo o sedute vale per le fatture nuove, non per quelle già fatte.':
            'Diese Leistung steht schon auf Rechnungen: Preis oder Sitzungen zu ändern gilt für neue Rechnungen, nicht für die bereits erstellten.',
        '«{nome}» salvato.': '«{nome}» gespeichert.',
        'Non posso rimetterlo in vendita: un altro servizio in vendita ha già lo stesso nome.':
            'Ich kann sie nicht wieder anbieten: Eine andere angebotene Leistung hat schon denselben Namen.',
        'Di nuovo in vendita: il pulsante torna nella nuova fattura.':
            'Wieder im Angebot: Der Knopf ist zurück auf der neuen Rechnung.',
        'Tolto dai pulsanti della fattura. Le fatture già fatte non cambiano.':
            'Von den Rechnungsknöpfen entfernt. Bereits erstellte Rechnungen ändern sich nicht.',
        'Scrivi come si chiama il servizio.': 'Schreib, wie die Leistung heisst.',
        'C’è già un servizio che si chiama «{nome}».': 'Es gibt schon eine Leistung namens «{nome}».',
        'Scrivi quanto costa il servizio.': 'Schreib, was die Leistung kostet.',
        'Il prezzo «{prezzo}» non si capisce: scrivilo per esempio 110.-':
            'Der Preis «{prezzo}» ist unklar: schreib ihn zum Beispiel als 110.-',
        'Le sedute vanno da 1 a 99.': 'Sitzungen gehen von 1 bis 99.',
        'I mesi di scadenza vanno da 1 a 60.': 'Die Monate bis zum Ablauf gehen von 1 bis 60.',
        'Il massimo non può essere minore delle sedute del mese ({sedute}).':
            'Das Maximum darf nicht kleiner sein als die Sitzungen pro Monat ({sedute}).',
        '1 seduta': '1 Sitzung',
        '{n} sedute': '{n} Sitzungen',
        '1 mese': '1 Monat',
        '{n} mesi': '{n} Monate',
        'manca il prezzo': 'Preis fehlt',
        'Manca il prezzo.': 'Preis fehlt.',
        '{prezzo} al mese': '{prezzo} pro Monat',
        '{prezzo} al mese.': '{prezzo} pro Monat.',
        '{prezzo}, una volta.': '{prezzo}, einmalig.',
        '{sedute} al mese': '{sedute} pro Monat',
        '{sedute}, da usare entro {mesi}.': '{sedute}, gültig für {mesi}.',
        '{sedute}, senza scadenza.': '{sedute}, ohne Ablaufdatum.',
        'Ogni mese {sedute}; quelle non usate passano al mese dopo, ma in un mese non se ne possono avere più di {massimo}.':
            'Jeden Monat {sedute}; nicht genutzte gehen in den nächsten Monat über, aber mehr als {massimo} kann man in einem Monat nicht haben.',
        'Ogni mese {sedute}; quelle non usate si perdono.': 'Jeden Monat {sedute}; nicht genutzte verfallen.',
